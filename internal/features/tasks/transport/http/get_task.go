...
//	@Description	Получить одну задачу конкретного пользователя по ID
//	@Tags			tasks
//	@Produce		json
//	@Param			id 		path 		int true							"ID получаемой задачи"
//	@Success		200		{object}	GetTaskResponse						"Успешно полученная задача"
...
func (h *TasksHTTPHandler) GetTask(rw http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		responseHandler.ErrorResponse(err, "falied to get task")
		return
	}
